...
export class UsersService {
    ...
    async hasValidRefreshToken(userId: number, refreshToken: string): Promise<boolean> {
    ...
    async searchUsers(searchTerm: string): Promise<User[]> {
        return this.usersRepository
            ...
            .where('LOWER(user.username) LIKE LOWER(:searchTerm) OR LOWER(user.email) LIKE LOWER(:searchTerm)', {
